...
public interface ICrawler {
     ...
     * saves its raw text data in array list of strings
     *
     * @warning This method needed for tests only
     *
     * @param page      Path to download first page
     * @param depth     How far we should go from the first downloaded page (= 0 if we
     *                  want to download only the first page)
     * @param pageCount Number of pages to be downloaded (when download the last page,
     *                  crawler will immediately stop processing and return control)
     *
     * @return Array of pages raw data
     */
    LinkedList<String> downloadCount(String page, int depth, int pageCount);
